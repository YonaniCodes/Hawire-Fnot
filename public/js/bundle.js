...
var alertsContainer = document.querySelector("body");
var showAlert = exports.showAlert = function showAlert(type, msg) {
  var alertDiv = document.createElement('div');
  alertDiv.classList.add('alert', "alert--".concat(type));
...
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } // Correct
  ...
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, type) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 5:
          res = _context.sent;
          if (res.status === 200) (0, _alert.showAlert)('success', "Updated!");
